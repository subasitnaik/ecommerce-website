    ...
    <div>
      ...
      <div className="w-full flex flex-col gap-y-4 max-[440px]:grid max-[440px]:grid-cols-2 max-[390px]:grid-cols-1">
        <SingleActivity
          ...
          percent="+20%"
        >
          <img src="/admin-assets/united-states.png" />
        </SingleActivity>
        <SingleActivity
          ...
          percent="+15%"
        >
          <img src="/admin-assets/united-kingdom.png" />
        </SingleActivity>
        <SingleActivity
          mainTitle="China"
          ...
          percent="+50%"
        >
          <img src="/admin-assets/china.png" />
        </SingleActivity>
        <SingleActivity
          mainTitle="Canada"
          totalVisitors="3,700"
          ...
          percent="+45%"
        >
          <img src="/admin-assets/canada.png" />
        </SingleActivity>
        <SingleActivity
          mainTitle="Germany"
          totalVisitors="8,100"
          ...
          percent="-5%"
        >
          <img src="/admin-assets/germany.png" />
        </SingleActivity>
        <SingleActivity
          mainTitle="France"
          totalVisitors="900"
          ...
          percent="-25%"
        >
          <img src="/admin-assets/france.png" />
        </SingleActivity>
      </div>
    </div>
  );
